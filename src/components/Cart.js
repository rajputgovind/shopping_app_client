...
const Cart = () => {
  ...
  const fetchCart = async () => {
    try {
      const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/get-cart/${user_id}`)
      ...
      // console.log(resp.data.data.productId)
    } catch (error) {
  ...
  const handleDelete = async(pid)=>{
    try {
      // alert(pid)
      const resp = await axios.delete(`${process.env.REACT_APP_BASE_URL}/delete-cart/${user_id}/${pid}`)
              ...
              <div className="site-blocks-table">
                <table className="table table-bordered">
                  ...
                  <td className="product-thumbnail">
                    <img
                      src={`${process.env.REACT_APP_BASE_URL}/public//images/${pid.pImage}`}
                      alt="Image"
                      className="img-fluid"
                    />
                  </td>
