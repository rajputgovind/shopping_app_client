...
const ShopSingle = () => {
  ...
  const handleClick = async () => {
    try {
      ...
      const resp = await axios.post(`${process.env.REACT_APP_BASE_URL}/insert-cart`, {
        productId: id,
        userId: userId,
        totalPrice: value,
        quantity: quantity
  ...
  const addWishList = async () => {
    try {
      const resp = await axios.post(`${process.env.REACT_APP_BASE_URL}/wishlist/insert-product`, {
        productId: id,
        userId: userId
      })
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <img src={`${process.env.REACT_APP_BASE_URL}/public/images/${singleData.pImage}`} alt="Image" className="img-fluid" />
