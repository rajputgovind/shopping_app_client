...
const ContextCart = () => {
    ...
    const fetchMen = async () => {
        try {
            const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/products/category/6481778f84241f241e000daa`)
    ...
    const fetChWomen = async () => {
        try {
            const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/products/category/648177b984241f241e000e59`)
            setWomen(resp.data)
        } catch (error) {
    ...
    const fetchChildren = async () => {
        try {
            const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/products/category/648177c584241f241e000e5b`)
    ...
    const fetchProduct = async (category) => {
        try {
            const resp = await axios.get(`${process.env.REACT_APP_BASE_URL}/products/${category}`,{
                headers:{
